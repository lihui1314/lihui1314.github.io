...
$$
C_1 = \text{AES\_Encrypt}(X_1,\text{key})
$$

3. 后续块使用前一个密文块作为“链”：

$$
C_2 = \text{AES\_Encrypt}(P_2 \oplus C_1,\text{key})
$$

$$
C_3 = \text{AES\_Encrypt}(P_3 \oplus C_2,\text{key})
$$
...
$$
X_1 = \text{AES\_Decrypt}(C_1,\text{key})
$$
...
$$
P_2 = \text{AES\_Decrypt}(C_2,\text{key}) \oplus C_1
$$

$$
P_3 = \text{AES\_Decrypt}(C_3,\text{key}) \oplus C_2
$$
